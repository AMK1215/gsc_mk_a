...
class ppCasino extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:pp-casino';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/pp_casino.json');
        $outputFilePath = base_path('app/Console/Commands/data/pplayCasinoModify.json');
