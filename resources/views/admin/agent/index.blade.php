                                            ...
                                            <td>
                                                @if ($user->status == 1)
                                                    <a onclick="event.preventDefault(); document.getElementById('banUser-{{ $user->id }}').submit();"
                                                        ...
                                                        data-bs-original-title="Active Master">
                                                ...
                                                @else
                                                    <a onclick="event.preventDefault(); document.getElementById('banUser-{{ $user->id }}').submit();"
                                                        class="me-2" href="#" data-bs-toggle="tooltip"
                                                        data-bs-original-title="InActive Master">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('admin.agent.makeCashIn', $user->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                    ...
                                                    <div class="modal fade" id="cashOutModal{{ $user->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{{ route('admin.agent.makeCashOut', $user->id) }}"
                                                                        method="POST">
                                                                        @csrf
