                    ...
                    <form action="{{ route('admin.agent.deposit') }}" method="GET">
                        <div class="row mt-3">
                                        ...
                                        <select name="agent_id" class="form-control">
                                            ...
                                            @foreach ($agents as $agent)
                                                <option value="{{ $agent->id }}"
                                                    ...
                                                    {{ $agent->user_name }}-{{ $agent->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <select name="status" id="" class="form-control">
                                        ...
                                        <option value="2" {{ request()->status == 2 ? 'selected' : '' }}>Reject
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <button class="btn btn-outline-primary btn-sm  mb-0 mt-sm-0" data-type="csv" type="button"
                                    name="button" id="export-csv">Export</button>
                        ...
                        <tbody>
                            @foreach ($deposits as $deposit)
                                <tr class="text-center" style="font-size: 15px !important;">
                                    ...
                                    <td><span
                                            class="badge text-bg-warning text-white ">{{ $deposit->user->parent->name }}</span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ route('admin.agent.depositShow', $deposit->id) }}"
